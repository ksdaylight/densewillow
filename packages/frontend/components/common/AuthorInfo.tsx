...
const AuthorInfo: FC<Props> = ({ profile }): JSX.Element => {
    ...
    return (
        <div className="p-2 border-2 border-secondary-gray rounded flex">
            {/* profile icons */}
            <div className="w-12">
            ...
            <div className="ml-2 flex-1">
                <h4 className="font-semibold text-primary-dark dark:text-white">{name}</h4>
                <p className="text-primary-dark dark:text-white opacity-90">{message}</p>
            </div>
        </div>
    );
};
