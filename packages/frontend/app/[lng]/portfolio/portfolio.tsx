        ...
        <div className="min-h-screen bg-dark_bg ">
            ...
            <main className="pl-0 pt-[50px] md:pl-[102px] md:pt-0 ">
                ...
                >
                    <div
                        id="meteor-shower"
                        className="absolute w-full h-screen overflow-hidden right-0 top-0"
                    >
                        {/* //top-[32px]这样的任意值不能使用  */}
                        {Array.from({ length: 15 }).map((_, index) => (
                            <span
                                ...
                                className={`absolute bg-[url('/images/meteor.png')] w-[60px] h-[49px] opacity-0 `} // animate-[meteor_4s_linear_infinite]
                            />
                        ))}
                    </div>
